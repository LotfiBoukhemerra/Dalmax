 ...
 */
public class MAin_Panel_pl2 extends javax.swing.JFrame {
    ...
    JButton move,button_old,button_hide;
    ...
    public MAin_Panel_pl2() {
        initComponents();
        selected.setVisible(false);
                    try {
                        cpt = input.readInt();
                    } catch (IOException ex) {
                        Logger.getLogger(MAin_Panel_pl2.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    if (cpt % 2 == 0) {
                        jLabel4.setIcon(O);
                    ...
                    try {
                        ...
                        if (player2.equals("on")) {
                            ...
                            if (player2.length() == 6) {
                                ...
                                hide_btn(i, j).setIcon(null);// case if eating happin
                                Matrix[i][j] = "";
                            }/** end if 2*/
                            turn_of();
                        }         
...
/**************************************************************/
  ...
  /**
    ...
    public void draw_in_your_panel(String s) {
        try {
            output.writeUTF("on2");// يتم إرسال هذا الأمر ليخبره أن يتلقى الأوامر
            output.writeUTF(s);
            output.writeInt(cpt);// مؤقتا فقط 
        } catch (IOException ex) {
            Logger.getLogger(MAin_Panel_pl2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
/**************************************************************/
  public JButton hide_btn(int x, int y){
...
/**************************************************************************************************/      
      ...
      if (player.equals("o") && Matrix[case_old.x][case_old.y].equals("o")) {
          if(case_old.y==0){
...
/*****************************main******************************/
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAin_Panel_pl2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MAin_Panel_pl2().setVisible(true);
            }
        });
        try {
            //con = new Socket("169.254.52.160", 5000);
            //con = new Socket("127.0.0.1", 5000);
            con = new Socket("localhost", 5000);
            //con = new Socket("192.168.8.1", 5000);
